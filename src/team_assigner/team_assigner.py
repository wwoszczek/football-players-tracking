...
class TeamAssigner:
    ...
    def _assign_team_color(self, frame, player_detections):
    ...
    def _get_player_team(self, frame, player_bbox, player_id):
    ...
    def assign_players_teams(self, tracks, video_frames):
        self._assign_team_color(video_frames[0], tracks["players"][0])
